import { WHATSAPP_URL, appPath, assetPath } from '../lib/format';
  ...
  return (
    <header className="fixed left-0 right-0 top-4 z-50 px-4 sm:px-6">
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4">
        ...
        <div className="liquid-glass hidden rounded-2xl px-5 py-3 md:block">
          <div className="flex items-center gap-5 text-sm font-medium text-white/90 lg:gap-7">
            {navItems.map((item) => (
              <a
                key={item.href}
